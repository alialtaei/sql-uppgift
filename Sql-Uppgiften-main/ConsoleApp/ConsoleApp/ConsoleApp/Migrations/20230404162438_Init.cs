        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    StatusNamn = table.Column<string>(type: "nvarchar(max)", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    KundTelefonNummer = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    KundCompany = table.Column<string>(type: "nvarchar(max)", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Created = table.Column<DateTime>(type: "datetime2", nullable: false),
                    Auktor = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    CaseId = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Kommentarer", x => x.Id);
                    table.ForeignKey(
                        name: "FK_Kommentarer_Cases_CaseId",
                        column: x => x.CaseId,
